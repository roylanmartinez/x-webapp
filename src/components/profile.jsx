        ...
        <div className="profile">
                      ...
                      <div className="rightProfile">
                        <div className="rightProfile0 divProfile">
                          ...
                          <small className="profileBiography">
                            asdfasdfasdf
                          </small>
                        ...
                        <ProfileSlider onOpenBigPost={(datos = null)=> {
                              this.props.history.push(
...
const Media = (props) => {
  ...
  if (!props.datos.name) {
    ...
    return (
      <div onClick={()=>props.onOpenBigPost(props.datos)} className="photoRP3">
          <img
            className="photoRP3Blur"
          ...
          <div className="photoRP3Info">
            ...
            <h1 className="photoRP3Info-points">{punctuation(props.datos.points)}</h1>
            <h5 className="photoRP3Info-date">February 6</h5>
          </div>
        </div>
    )
