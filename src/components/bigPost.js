...
const BigPost = (props) => {
  ...
  return (
    <div onClick={props.onClickBackground} className="BigPostBackground">
      <div className="leftBigPost">
        <div className="photoBigPost">
          <img
            className="photoBigPostBlur"
            src={
              require(`../assets/images/test${state.dato.image}.jpg`).default
            }
            alt={"test1.jpg"}
          ></img>
          ...
          <div className="photoBigPostInfo">
            ...
            <div onClick={handleRight} className="photoBigPostInfo-ArrowRight">
      ...
      <div className="rightBigPost">
        <div className="rightBigPost0">
          ...
          <div className="rightBigPost0Tittle">
            ...
            <small className="rightBigPost0TittleSmall">
              3h • <i className="fas fa-globe-americas"></i>{" "}
            </small>
          </div>
        </div>

        <p className="rightBigPost1">
          {state.text.length >= 400 && state.readMore === false
            ? state.text.slice(400, 10)
            : state.text}

          <span
            onClick={() => setState({ ...state, readMore: true })}
            // style={{display: (this.state.readMore) ? "block" : "none"}}
            className={
              "rightBigPost_comment_readMore" +
              (state.readMore ? "_true" : "_false")
            }
          >
            ...read more
          </span>
        ...
        <div className="rightBigPost2">
          <div className="rightBigPost2_pointHolder">
            ...
            <h6 className="rightBigPost2_numberLikes">23 likes</h6>
          </div>

          <h6 className="rightBigPost2_numberComments">2 comments</h6>
        </div>
    ...
    <React.Fragment>
      <div className="rightBigPost_comment">
        ...
        <div className="rightBigPost_comment_right">
          <b className="rightBigPost_comment_title">
            Queralt Vargas asdf asdf asdf asdfa sdf asdfasdf
          </b>
          <small className="ml-2 mr-2">@roylanmartinez12</small>
          <p className="rightBigPost_comment_text">
            {text.length >= 200 && readMore === false
              ? text.slice(0, 200)
              : text}
            <span
      ...
      <div className="rightBigPost_comment_bottom">
        ...
        <small className="rightBigPost_comment_bottom_text_report">•••</small>
        {/* <div></div> */}
      </div>
    </React.Fragment>
  );
